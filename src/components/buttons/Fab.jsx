// credit https://raw.githubusercontent.com/MarkosKon/already-styled-components

import PropTypes from "prop-types";
import styled, { css } from "styled-components";
import { darken, transparentize, getLuminance, lighten } from "polished";
...
const Fab = styled.button`
  ...
  &:hover {
    animation: none;
    background-color: ${({ bc }) =>
      getLuminance(bc) < 0.06 ? lighten(0.15, bc) : darken(0.07, bc)};
  }
